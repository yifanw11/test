...
def main():
    ...
    # Both switch MAC
    #update_src_mac_add_entry(target, table, dst_ip, prefix_len, src_mac)
    ...
    ipv4_forward_add_entry(target, ipv4_forward_table, config["host_ip_prefix"], 24, config["switch_host_port"])
